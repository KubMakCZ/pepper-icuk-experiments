...
public class MainActivity extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    private final List<String> topicNames = Arrays.asList("main", "screenone", "screentwo", "concepts", "everything", "screenthree", "screenfour", "screenfive", "screensix", "screenseven", "screeneight", "screennine", "screenten");
